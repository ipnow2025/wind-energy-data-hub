...
export default function NewCollaborationPostPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const board = author.toUpperCase()

      const res = await fetch("/api/collaboration/posts", {
        method: "POST",
        headers,
        body: JSON.stringify({
      ...
      if (res.ok) {
        const toEmail = await getBoardEmail(board)
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Input value={author.toUpperCase()} disabled className="mt-1 bg-gray-50" />
                    </div>
                  </div>
                </div>
              </div>
