...
import { FileText, List, Download, Copy, CheckCircle2 } from "lucide-react"
          ...
          <div className="max-w-5xl mx-auto">
            <div className="space-y-6 p-6 border border-border rounded-lg bg-white">
              ...
              <div>
                ...
                <div className="min-h-[300px] p-4 rounded border whitespace-pre-wrap bg-background">{post.content}</div>
              </div>
