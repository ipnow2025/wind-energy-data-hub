...
export default function AdminCollaborationPostDetailPage() {
            ...
            <div className="space-y-6 p-6 border border-border rounded-lg bg-white">
              <div className="flex items-center justify-between pb-4 border-b">
                ...
                <div className="flex gap-2">
                  <Button onClick={() => router.push("/admin/collaboration")} disabled={isDeleting} variant="outline">
                    <List className="mr-2 h-4 w-4" />
                    목록
                  </Button>
                  <Button
                    onClick={() => router.push(`/admin/collaboration/post/${postId}/edit`)}
                    disabled={isDeleting}
